#ifndef __GENERIC_AUTOMATION_RAW_BYTE_SERIALIZER_HPP__
#define __GENERIC_AUTOMATION_RAW_BYTE_SERIALIZER_HPP__
...
namespace genauto {
     ...
     */
    template<class MSG>
    class RawByteSerializer : public MessageSerializer {
